...
class heavy(osha.loadtest.base.TestCase):
    ...
    def test_heavy(self):
        ...
        * Logoff
        ...
        self.get('/nl')
        self.assertEllipsis('...Highlights...In Focus...Menu...Gratis nieuwsbrief...Twitter...', self.getBody())
        ...
        # self.assertEllipsis('...', self.getBody())
        self.get('/lv')
        self.assertEllipsis('...Highlights...In Focus...Bezmaksas...Twitter...', self.getBody())
        # defekte Seite
        ...
        self.get('/de')
        self.assertEllipsis('...Highlights...In Focus...Kostenloser Newsletter...Twitter...', self.getBody())
